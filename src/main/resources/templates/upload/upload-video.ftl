...
<div id="videolist">你的浏览器不支持flash,Silverlight或者HTML5！</div>

<br/>

<div id="container">
	<a id="selectvideo" href="javascript:void(0);" class='btn btn-primary'>选择文件</a>
	<a id="uploadvideo" href="javascript:void(0);" class='btn btn-danger'>开始上传</a>
</div>
