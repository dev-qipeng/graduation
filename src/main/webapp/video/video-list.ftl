...
<footer class="footer">
    <ul class="pagination">
        <#if pageInfo.hasPreviousPage?then('true', 'false') == 'true'>
            <li class="page-item"><a class="page-link" href="${ctx}/video/list.do?pageNum=${pageInfo.pageNum-1}">Previous</a></li>
        <#else>
        ...
        <#list pageInfo.navigatepageNums as page_num>
            ...
            <#else>
                <li class="page-item"><a class="page-link" href="${ctx}/video/list.do?pageNum=${page_num}">${page_num}</a></li>
            </#if>
        </#list>
        <#if pageInfo.hasNextPage?then('true', 'false') == 'true'>
            <li class="page-item"><a class="page-link" href="${ctx}/video/list.do?pageNum=${pageInfo.pageNum+1}">Next</a></li>
        <#else>
